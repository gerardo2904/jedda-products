	...
	<div class="profile-content">
		<div class="container">
			<div class="row">
				<div class="profile">
					<div class="avatar">
						<img src="{{ $client->featured_image_url }}" alt="Circle Image" class="img-circle img-responsive img-raised">
					</div>
					
					
					<div class="name">
						<h3 class="title">{{ $client->name }}</h3>
						<h4 class="title">{{ 'RFC '.$client->rfc }}</h4>
			...
			<div class="description text-center">
				...
				<p>{{ 'C.P. '. $client->cp.', Telefono '.$client->tel }}</p>
