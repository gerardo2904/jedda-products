...
class ProductionOrderController extends Controller
{
    ...
    public function create()
    {
        ...
        ->select('production_order.id_company', DB::raw('CONCAT(UPPER(SUBSTRING(companies.name,1,3)),"-",(if((production_order.orden REGEXP "^[0-9]")=1,CAST(production_order.orden AS UNSIGNED) + 1,CAST(substr(production_order.orden,5,10) AS UNSIGNED) + 1))) as orden'), DB::raw('CAST(production_order.orden AS UNSIGNED) as orden'))
